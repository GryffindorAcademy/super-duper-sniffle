...
export default class Ann extends Component {
  ...
  render() {
    return (
      <div className="test">
        <ScrollToTop />
        <header className="annHeader">
          <div className="annHeader__background">
            <div className="annHeader__title">
              <span>Hi, I'm Ann Ndunge</span>
            </div>
          </div>
        </header>
        <div className="annStory">
          <img className="annStory__picture" src={AnnStory} />
          <section className="annStory__containerQuestions">
            ...
            <div className="annStory__containerQuestions--subtext1">
              <p>
                I got interested in computers back in 2014 just after joining
            ...
            <div className="annStory__containerQuestions--text2">
              <span>
                What projects are you proud of, or what projects are you
                currently working on?
              </span>
            </div>
            <div className="annStory__containerQuestions--subtext2">
              <p>
                While at Tunapanda I worked on a project that made a website
          ...
          <section className="annStory__container">
